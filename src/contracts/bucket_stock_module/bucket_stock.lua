BucketStock = {
    ...
    Initialized = false,
    State = {
        -- YieldBetProcess = '', -- replace
        -- Stocks = {}
    }
}

if not BucketStock.State.YieldBetProcess then BucketStock.State.YieldBetProcess = id end
if not BucketStock.State.Stocks then BucketStock.State.Stocks = {} end
